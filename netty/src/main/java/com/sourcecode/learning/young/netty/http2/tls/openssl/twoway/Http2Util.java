package com.sourcecode.learning.young.netty.http2.tls.openssl.twoway;


import com.sourcecode.learning.young.netty.http2.tls.openssl.twoway.client.SecureChatHttp2ClientResponseHandler;
import com.sourcecode.learning.young.netty.http2.tls.openssl.twoway.client.SecureChatHttp2ClientSettingsHandler;
import com.sourcecode.learning.young.netty.http2.tls.openssl.twoway.server.SecureChatHttp2ServerResponseHandler;
...
public class Http2Util {
                ...
                if (ApplicationProtocolNames.HTTP_2.equals(protocol)) {
                    ctx.pipeline()
                            .addLast(Http2FrameCodecBuilder.forServer()
                                    .build(), new SecureChatHttp2ServerResponseHandler());
                    return;
                }
    ...
    public static ApplicationProtocolNegotiationHandler getClientAPNHandler(int maxContentLength, SecureChatHttp2ClientSettingsHandler settingsHandler, SecureChatHttp2ClientResponseHandler responseHandler) {
